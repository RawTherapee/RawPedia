...
<!-- - [Premiers pas](getting_started/fr) -->
<!-- - [Propriétés](features/fr) -->
<!-- - [Téléchargement](download/fr) -->
<!-- - [Le calcul en virgule -->
<!--   flottante](The_Floating_Point_Engine/fr.md) -->
<!-- - [Profondeur de couleur](bit_depth/fr) -->
<!-- - [RVB et Lab](rgb_and_lab/fr) -->
<!-- - [Le Navigateur de fichiers](the_file_browser_tab/fr) -->
<!-- - [La file d'attente](the_batch_queue/fr) -->
<!-- - [L’Éditeur](the_image_editor_tab/fr) -->
<!-- - [Ajustements par lots - Sync](batch_adjustments_-_sync/fr) -->
<!-- - [Enregistrer les images](saving_images/fr) -->
...
<!-- - [Où sont les fichiers ?](file_paths/fr) -->
<!-- - [Préférences](preferences/fr) -->
<!-- - [Le plugin GIMP](gimp_plugin/fr) -->
<!-- - [Générateur de profil ICC](icc_profile_creator/fr) -->
<!-- - [Réaliser une installation -->
<!--   portable](Making_a_Portable_Installation/fr.md) -->
<!-- - [Options en ligne de commande](command-line_options/fr) -->
<!-- - [Raccourcis clavier](keyboard_shortcuts/fr) -->
...
<!-- - [RTProfileSelector](rtprofileselector/fr) -->
<!-- - [RTbatch](rtbatch/fr) -->
...
<!-- - [Pop](pop) -->
<!-- - [Sans suppression hors domaine](unclipped/fr) -->
...
<!-- - [Onglet Favoris](favorites_tab/fr) -->
...
<!-- - [Gamma - Différentiel](gamma_-_differential/fr) -->
<!--   (development) -->
<!-- - [Ombres/Hautes lumières](shadows/highlights/fr) -->
<!-- - [Compression tonale](tone_mapping/fr) -->
<!-- - [Compression de Plage -->
<!--   Dynamique](Dynamic_Range_Compression/fr.md) -->
<!-- - [Filtre Vignettage](vignetting_filter/fr) -->
<!-- - [Filtre dégradé](graduated_filter/fr) -->
<!-- - [Ajustements L\*a\*b\*](lab_adjustments/fr) -->
...
<!-- - [Balance des blancs](white_balance/fr) -->
<!-- - [cat02 adaptation](cat02/fr) -->
<!-- - [Vibrance](vibrance/fr) -->
<!-- - [Mixage des canaux](channel_mixer/fr) -->
<!-- - [Noir-et-Blanc](black-and-white/fr) -->
<!-- - [Noir-et-Blanc_Supplément](black-and-white_addon/fr) -->
<!-- - [Egaliseur TSV](hsv_equalizer/fr) -->
<!-- - [Simulation de film](film_simulation/fr) -->
<!-- - [Lumière douce](soft_light/fr) -->
<!-- - [Courbes RVB](rgb_curves/fr) -->
<!-- - [Virage partiel](color_toning/fr) -->
...
<!-- - [Contrôles locaux Lab](local_lab_controls/fr) -->
...
<!-- - [Recadrage](crop/fr) -->
<!-- - [Redimensionnement](resize/fr) -->
<!-- - [Objectif/Géométrie](lens/geometry/fr) -->
...
<!-- - [Dématriçage](demosaicing/fr) -->
<!-- - [Points Noirs raw](raw_black_points/fr) -->
<!-- - [Traitement pré-dématriçage](preprocessing/fr) -->
<!-- - [Aberration Chromatique](chromatic_aberration/fr) -->
<!-- - [Points Blancs raw](raw_white_points/fr) -->
<!-- - [Trame Noire](dark_frame/fr) -->
<!-- - [Champ Uniforme](flat_field/fr) -->
<!-- - [Film Négatif](film_negative/fr) -->
...
<!-- - [Modes de copie des métadonnées](metadata_copy_mode/fr) -->
<!-- - [Onglet EXIF](exif_tab/fr) -->
<!-- - [Onglet IPTC](iptc_tab/fr) -->
...
<!-- - [Traduire RawTherapee](translating_rawtherapee/fr) -->
<!-- - [Traduire RawPedia](translating_rawpedia/fr) -->
